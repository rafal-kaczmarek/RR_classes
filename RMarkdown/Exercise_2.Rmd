...
load(paste0("../april_05_09/data/season_", params$season,".RData"))
```
...
```{r viewers_plot}
plot(season_data$viewers, type=params$line_type, col=params$line_color, lwd=5,main =paste0("Season ",params$season), xlab = "Episode number", ylab = "1st day TV viewers in the US (millions)")
```
